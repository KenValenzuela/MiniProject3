  ...
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        {/* Stats Counter Overlay - Top Left Corner - Dynamic based on scrubber position */}
        {(stats || loadingStats) && (
          <div
            style={{
              position: 'absolute',
            ...
            {loadingStats ? (
              ...
              <div style={{ fontSize: '13px', lineHeight: '1.6' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                  ...
                  <span style={{ fontWeight: '600' }}>{stats.occupied || 0}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                  <span style={{ color: '#ffff00' }}>●</span>
                  <span style={{ flex: 1, marginLeft: '8px' }}>Vacant:</span>
                  <span style={{ fontWeight: '600' }}>{stats.vacant || 0}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid rgba(255,255,255,0.2)', paddingTop: '6px', marginTop: '6px' }}>
                  ...
                  <span style={{ fontWeight: '700' }}>{stats.total_slots || 0}</span>
                </div>
              </div>
            ) : null}
          </div>
